            ...
            <div className="flex flex-col ">
                ...
                <div className="mt-4 md:mt-0 flex flex-col md:flex-row">
                    ...
                    <div className="mt-4 md:mt-0 flex-1 flex items-center justify-center md:border-r border-gray-100">
                        <a className="hover:text-white text-white" href="https://github.com/Charlie85270/tail-kit">
                        ...
                        <a className="ml-4 text-white hover:text-white" href="#">
                            <span className="sr-only">
                                Settings
                            </span>
                    ...
                    <div className="mt-7 md:mt-0 flex-1 flex flex-col items-center text-white justify-center md:items-start md:pl-5">
                        <span className="">
                            © 2021
                        </span>
                        <span className="mt-7 md:mt-1">
                            Created by
                            <a className="underline hover:text-primary-gray-20" href="https://www.helix.vision/">
                                Triple Helix Creative
                            </a>
                        </span>
                    </div>
                </div>
